        ...
        <div className='grid w-full grid-cols-8 gap-16 sm:gap-6'>
          <div className='col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8'>
            ...
            <p className='font-medium'>
              Hi, I'm Cephus, a web developer and UI/UX designer with a passion for creating beautiful, functional, 
...
<div className='absolute top-0 -right-3 -z-10 w-[102%] h-[103%] rounded-[2rem] bg-dark dark:bg-light'/>
  <Image src= {profilePic} alt ='Cephus' className='w-full h-auto rounded-2x1'/>
</div>
