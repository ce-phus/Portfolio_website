    ...
    <button className='flex-col justify-center items-center hidden lg:flex' onClick={handleClick}>
     ...
     <nav>
      ...
      
      {
        ...
        className='min-w-[70vw] flex flex-col items-center justify-between  z-30 fixed top-1/2 -translate-x-2 -translate-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-m py-32'>
